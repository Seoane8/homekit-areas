...
## Fase 0 — Investigación técnica HomeKit

> Verificar que la investigación está documentada y es coherente.

### Test 0.1 — Documento de arquitectura

- [x] **Paso 1:** Abrir `docs/homekit-architecture.md`
- [x] **Paso 2:** Verificar que el documento existe y tiene contenido
- [x] **Resultado esperado:** El documento existe y tiene al menos 100 líneas

### Test 0.2 — Respuestas a las 10 preguntas

- [x] **Paso 1:** En `docs/homekit-architecture.md`, buscar la sección "Respuestas a las 10 preguntas"
- [x] **Paso 2:** Verificar que las 10 preguntas del plan §6 están respondidas
- [x] **Resultado esperado:** Cada pregunta tiene una respuesta clara y documentada

### Test 0.3 — Solución elegida documentada

- [x] **Paso 1:** Buscar la sección "Solución elegida" en el documento
- [x] **Paso 2:** Verificar que se explica la decisión de orquestar `ConfigEntry`-s del dominio `homekit`
- [x] **Paso 3:** Verificar que se mencionan las APIs utilizadas (`flow.async_init`, `SOURCE_IMPORT`, etc.)
- [x] **Resultado esperado:** La solución está justificada y las APIs están listadas

### Test 0.4 — Alternativas consideradas

- [x] **Paso 1:** Buscar la sección "Alternativa considerada" en el documento
- [x] **Paso 2:** Verificar que se menciona la alternativa de instanciar `HomeKit`/`HomeDriver` directamente
- [x] **Paso 3:** Verificar que se explica por qué se descarta como primaria
- [x] **Resultado esperado:** La alternativa está documentada con sus pros/contras
...
- [ ] **Paso 1:** En la entrada de "HomeKit Areas", pulsar "Configurar"
- [ ] **Paso 2:** Verificar que se muestran las opciones guardadas (áreas, puerto, dominios, exclusiones)
- [ ] **Resultado esperado:** Las opciones coinciden con lo configurado
...
### Test 3.1 — Modificar áreas

- [ ] **Paso 1:** En la entrada de "HomeKit Areas", pulsar "Configurar"
- [ ] **Paso 2:** Cambiar la selección de áreas (añadir/quitar alguna)
- [ ] **Paso 3:** Pulsar "Guardar"
- [ ] **Resultado esperado:** Las opciones se actualizan, la integración se recarga

### Test 3.2 — Modificar puerto inicial

- [ ] **Paso 1:** Pulsar "Configurar"
- [ ] **Paso 2:** Cambiar el puerto inicial
- [ ] **Paso 3:** Pulsar "Guardar"
- [ ] **Resultado esperado:** El puerto se actualiza

### Test 3.3 — Modificar dominios

- [ ] **Paso 1:** Pulsar "Configurar"
- [ ] **Paso 2:** Cambiar los dominios seleccionados
- [ ] **Paso 3:** Pulsar "Guardar"
- [ ] **Resultado esperado:** Los dominios se actualizan

### Test 3.4 — Modificar entidades excluidas

- [ ] **Paso 1:** Pulsar "Configurar"
- [ ] **Paso 2:** Cambiar las entidades excluidas
- [ ] **Paso 3:** Pulsar "Guardar"
- [ ] **Resultado esperado:** Las exclusiones se actualizan
...
- [ ] **Paso 1:** Revisar `models.py`
- [ ] **Paso 2:** Verificar que existe una clase/dataclass `AreaBridge` o similar
